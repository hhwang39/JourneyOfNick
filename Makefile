...
OFILES = mylib.o main.o text.o font.o map.o sprite.o myGame.o sprite2.o map2.o font.o sprite3.o win.o bd.o end.o win2.o bd2.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h myGame.h sprite.h map.h text.h sprite2.h sprite.h sprite3.h win.h bd.h end.h
